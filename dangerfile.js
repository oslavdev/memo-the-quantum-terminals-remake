...
if (pr.base.repo.full_name !== pr.head.repo.full_name) {
    warn("🕵️ This PR comes from a fork, and won't get JS generated for QA testing this PR inside the Emission Example app.")
}
...
if (packageChanged && !lockfileChanged) {
    warn(`Changes were made to package.json, but not to yarn.lock - <i>'Perhaps you need to run yarn?'</i>`);
}
